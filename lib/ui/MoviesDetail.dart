...
import 'package:flutter_movies_app/blocs/MoviesDetailBloc.dart';
...
class MoviesDetailState extends State<MoviesDetail> {
  final posterUrl;
  final description;
  final releaseDate;
  final String title;
  ...
  void didChangeDependencies() {
    bloc = MoviesDetailBlocProvider.of(context);
